...
export default [
	...
	{
		path: 'recovery-plan-generator',
		loadComponent: () =>
			import('./pages/recovery-plan-generator.component').then(
				(mod) => mod.RecoveryPlanGeneratorComponent,
			),
	...
	},
	{
		...
		loadComponent: () =>
			import('./pages/recovery-plan-detail.component').then(
				(mod) => mod.RecoveryPlanDetailComponent,
			),
		title: 'Detalles del Plan de Recuperación',
	},
	{
		...
		title: 'Generador de Plan de Mejora',
	},
	{
