...
@Component({
	...
	styles: [
		`
			...
			.study-path-result-content strong {
				/* Example: Bold text for headings */
				display: block;
				margin-top: 1em;
				margin-bottom: 0.5em;
				font-weight: bold;
			...
			.study-path-result-content ul,
			.study-path-result-content ol {
				padding-left: 30px;
				margin-top: 0.5em;
				margin-bottom: 1em;
			}
			...
			sections: [
				{
					...
					children: [
						new Paragraph({
							text: `Ruta de Estudio Sugerida`,
							heading: HeadingLevel.HEADING_1,
							alignment: AlignmentType.CENTER,
							spacing: { after: 100 },
						}),
						new Paragraph({
							text: `Para: ${formValue.topicSkill}`,
							heading: HeadingLevel.HEADING_2,
							alignment: AlignmentType.CENTER,
							spacing: { after: 300 },
						}),
						new Paragraph({
							text: `Nivel Objetivo: ${formValue.masteryLevel}`,
							alignment: AlignmentType.CENTER,
