...
@Component({
	...
	imports: [MatTableModule, SimpleList, PretifyPipe],
	template: `
		@if (plan(); as plan) {
			<div>
					...
					<tbody>
						<tr>
							<td>
								<div>
									<div>
										<b>Competencia específicas del grado</b
										>:
									</div>
							...
							<td>
								<app-simple-list
									[items]="plan.evaluationTypes"
								/>
							</td>
							<td>
								<app-simple-list
									[items]="plan.evaluationParticipants"
								/>
							</td>
						</tr>
					</tbody>
				...
				<div style="margin-top: 24px; padding-bottom: 24px;">
					...
					>
						<tbody>
							<tr>
								<th colspan="4">
									Aspecto de la competencia específica del
									grado
								</th>
								<th colspan="4">Indicadores de Logro</th>
							...
							<tr>
								...
								<td colspan="4">
									<app-simple-list
										[items]="area.achievementIndicators"
									/>
								</td>
								<td colspan="4">
							...
							@for (
								block of area.evaluationBlocks;
								track block;
								let i = $index
							) {
								@if (i == 0) {
								...
								<tr>
									<td colspan="3">
										{{ block.achievementIndicatorAspect }}
									</td>
									<td colspan="3">
										<app-simple-list
											[items]="block.evidences"
										/>
									</td>
