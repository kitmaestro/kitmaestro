...
export default [
	{ path: '', loadComponent: () =>import('./pages/diagnostic-evaluation-generator.component').then((m) => m.DiagnosticEvaluationGeneratorComponent), title: 'Generador de Pruebas Diagnósticas' },
	{
		path: 'diagnostic-evaluation-generator',
		loadComponent: () =>
			import(
				'./pages/diagnostic-evaluation-generator.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/diagnostic-evaluations.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/diagnostic-evaluation-detail.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/checklist-generator.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/checklist-detail.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/test-generator.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/observation-sheet.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/observation-sheets.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/observation-sheet-detail.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/rubric-generator.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/rubric-lot-generator.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/estimation-scale.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/estimation-scales.component'
	...
	},
	{
		...
		loadComponent: () =>
			import(
				'./pages/estimation-scale-detail.component'
