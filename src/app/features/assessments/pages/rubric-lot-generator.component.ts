                    ...
                    @if (!generating) {
                        ...
                        >
                            <p>
                                ...
                                <strong>cada tema</strong> disponible en la asignatura y
                                grado seleccionados.
                            </p>
                            ...
                            <div class="grid-2-cols">
                                ...
                                <mat-form-field appearance="outline">
                                    ...
                                    <mat-select formControlName="rubricType">
                                        @for (type of rubricTypes; track type.id) {
                        ...
                        <div class="spinner-container">
                            ...
                            <mat-card style="width: 100%; max-width: 600px">
                                <mat-card-content>
                                    <h4>Progreso:</h4>
                                    @for (status of generationStatus; track status) {
                                        <div>{{ status }}</div>
                                    }
                                </mat-card-content>
                            </mat-card>
...
export class RubricLotGeneratorComponent implements OnInit {
    ...
    onSubmit() {
        ...
        const { section: sectionId, subject, rubricType, levels } =
        ...
        return dataFetch$.pipe(
            concatMap(({ contentBlocks, competences, aiTitle }) => {
                ...
                const selectedCompetences = competences.flatMap(
                    (entry) =>
                        this.getRandomItems(entry.entries, 1)[0] || [],
                );
