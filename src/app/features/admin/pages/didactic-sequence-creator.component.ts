	...
	template: `
		<div class="container">
			<mat-card>
				<mat-card-header>
					<mat-card-title
						>Crear Nueva Secuencia Didáctica</mat-card-title
					>
					<button mat-button routerLink="/admin/didactic-sequences">
						...
						<mat-stepper linear #stepper>
							...
							<mat-step [stepControl]="basicInfoForm">
								<ng-template matStepLabel
									>Información Básica</ng-template
								>
							...
							<mat-step [stepControl]="tableOfContentsForm">
								<ng-template matStepLabel
									>Tabla de Contenidos</ng-template
								>

								<div class="step-content">
									<div formArrayName="tableOfContents">
										@for (
											item of tableOfContents.controls;
											track item;
											let i = $index
										) {
											<mat-expansion-panel>
...
export class DidacticSequenceCreatorComponent implements OnDestroy {
	...
	schoolLevels = ['PRE_PRIMARIA', 'PRIMARIA', 'SECUNDARIA'];
	schoolYears = [
		'PRIMERO',
		'SEGUNDO',
		'TERCERO',
	...
	onSubmit() {
		const sequence: DidacticSequenceDto =
			this.form.getRawValue() as DidacticSequenceDto;
		if (this.form.valid) {
