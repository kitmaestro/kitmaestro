export const SCIENCE_COMPETENCE = {
    Primaria: {
        Comunicativa: {
            Primero: {
                ...
                criteriosDeEvaluacion: [
                    'Compresión básica de la información científica y tecnológica, utilizando el lenguaje apropiado.',
                ],
            },
            Segundo: {
                competenciasEspecificas: [
                ...
                criteriosDeEvaluacion: [
                    'Análisis y evaluación apropiada de la idea que desea transmitir, argumentando a partir de la observación y experimentación.',
                ],
            },
            Tercero: {
                competenciasEspecificas: [
            ...
            Cuarto: {
                competenciasEspecificas: [
                    'Ofrece explicaciones científicas y tecnológicas a partir de análisis, observaciones, medición, modelos y experimentación de fenómenos naturales fundamentales en contexto próximo o experimentado o modelado en ciencias de la vida, físicas, de la tierra y el universo.',
                ],
                criteriosDeEvaluacion: [
                    'Utilización de lenguaje científico y tecnológico apropiado, mostrando comprensión de la información que comunica.',
                ],
            },
            Quinto: {
                competenciasEspecificas: [
            ...
            Sexto: {
                ...
                criteriosDeEvaluacion: [
                    'Justificación de explicaciones con argumentación a partir de la observación, análisis, experimentación y evaluación apropiada de la idea que desea transmitir.',
                ],
            },
        },
        PensamientoLogico: {
            Primero: {
                ...
                criteriosDeEvaluacion: [
                    ...
                    'Identificación y utilización adecuada de objetos, juegos, instrumentos, herramientas y técnicas según la tarea a realizar.',
                ],
            },
            Segundo: {
                competenciasEspecificas: [
                ...
                criteriosDeEvaluacion: [
                    'Identificación y ejecución de procedimiento sencillo y pertinente al problema, modelo, experimento o situación.',
                    'Identificación aportes científicos y tecnológicos, y profesionales en ciencias e ingenierías.',
                    'Asociación adecuada de contenidos científicos y tecnológicos.',
                ],
            },
            Tercero: {
                ...
                criteriosDeEvaluacion: [
                    'Argumentación, secuencia lógica y objetividad en sus conclusiones de las tareas realizadas.',
                    'Autoanálisis de la elección y los pasos del procedimiento.',
                    'Planificación y utilización de instrumentos, herramientas, juegos y modelos.',
                    'Curiosidad, creatividad, perseverancia, colaboración, organización y finalización de la tarea.',
                ],
            },
            Cuarto: {
                competenciasEspecificas: [
                ...
                criteriosDeEvaluacion: [
                    'Asociación adecuada de contenidos científicos y tecnológicos.',
                    'Identificación y utilización adecuada de objetos, juegos, instrumentos, herramientas y técnicas según la tarea a realizar.',
                    'Análisis de la elección y del procedimiento a seguir.',
                ],
            },
            Quinto: {
                competenciasEspecificas: [
            ...
            Sexto: {
                ...
                criteriosDeEvaluacion: [
                    'Diseño y utilización de instrumentos, herramientas, juegos y modelos.',
                    'Compresión y formulación adecuada del problema, pregunta, modelo o situación científica o tecnológica',
                    'Argumentación, secuencia lógica y objetividad en sus conclusiones de las tareas realizadas.',
                    'Identificación aportes científicos y tecnológicos, y profesionales en ciencias e ingenierías.',
                ],
        ...
        EticaYCiudadana: {
            Primero: {
                ...
                criteriosDeEvaluacion: [
                    'Compresión y cuidado del medioambiente, así como los recursos de bien común.',
                    'Actitudes y comportamientos adecuados para sí mismo y con los demás.',
                    'Respeto a ideas y diferencias de los demás.',
                ],
            },
            Segundo: {
                competenciasEspecificas: [
                    'Asume una actitud constructiva, reflexiva y en armonía en sí mismo, con los demás, con su entorno y como parte de los seres vivos, tomando acciones básicas y proactivas en atención a su bienestar y uso sostenibles de los recursos.',
                ],
                criteriosDeEvaluacion: [
                    'Compresión, apreciación y cuidado de seres vivos y mascotas.',
                    'Identificación de actitudes reforzadas en la ciencia que aporta a su desarrollo personal.',
                    'Aporte y responsabilidad en el trabajo de equipo.',
                ],
            },
            Tercero: {
                competenciasEspecificas: [
                ...
                criteriosDeEvaluacion: [
                    'Reconocimiento de las necesidades y convivencias en armonía con todos los demás.',
