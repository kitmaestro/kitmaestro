        ...
        Comunicativa: {
            Primero: {
                ...
                criteriosDeEvaluacion: [
                    'Expresión de sus ideas matemáticas en la búsqueda de soluciones a situaciones de problemas elementales relacionados con su entorno cotidiano',
                ],
            },
            Segundo: {
                competenciasEspecificas: [
                    'Explica, en forma oral y escrita, sus ideas sobre conceptos y situaciones con contenido matemático, relacionando su lenguaje diario con el lenguaje y los símbolos matemáticos.',
                ],
                criteriosDeEvaluacion: [
                    'Relaciona el lenguaje cotidiano con los símbolos matemáticos en el proceso de comunicación de sus ideas matemáticas.',
                ],
            },
            Tercero: {
                competenciasEspecificas: [
                    'Representa -leyendo, escribiendo, interpretando y discutiendo-su comprensión de los enunciados de problemas matemáticos, los conceptos y propiedades de las operaciones, para establecer las relaciones entre ellos y con el contexto circundante.',
                ],
                criteriosDeEvaluacion: [
                    'Lectura, escritura y traducción de las expresiones matemáticas, incorporándolas a su lenguaje y formas de comunicación habitual, incrementando su precisión y rigurosidad.',
                ],
            },
            Cuarto: {
                competenciasEspecificas: [
                ...
                criteriosDeEvaluacion: [
                    'Interpretación de ideas matemáticas utilizando destrezas comunicativas.',
                ],
            },
            Quinto: {
                competenciasEspecificas: [
            ...
            Sexto: {
                ...
                criteriosDeEvaluacion: [
                    'Interpretación de diferentes símbolos matemáticos para la comunicación efectiva de las ideas.',
                ],
            },
        },
        PensamientoLogico: {
            Primero: {
                competenciasEspecificas: [
                    'Resuelve problemas matemáticos, en forma coherente y con el apoyo de recursos manipulativos y digitales; identificando patrones, estructuras o regularidades de forma inductiva para la explicación matemática de situaciones cotidianas.',
                ],
                criteriosDeEvaluacion: [
                    'Razonamiento lógico frente a problemas del entorno propios de la Matemática.',
                    'Empleo de diferentes ideas matemáticas para la resolución de problemas referidos al entorno.',
                    'Uso de tecnologías digitales en situaciones desde la Matemática.',
                ],
            },
            Segundo: {
                competenciasEspecificas: [
                    'Utiliza el enfoque de resolución de problemas para entender los contenidos matemáticos, estableciendo e investigando conjeturas para justificar argumentos y pruebas relacionadas con éstos, de acuerdo con su desarrollo cognitivo, apoyándose en recursos concretos, y en recursos y soportes digitales, para complementar el trabajo matemático.',
                ],
                criteriosDeEvaluacion: [
                    'Aplicación del enfoque de resolución de problemas para investigar ideas matemáticas.',
                    'Formulación de conjeturas para justificar argumentos relacionados con el trabajo matemático.',
                    'Reconocimiento de recursos concretos y herramientas tecnológica para resolver problemas matemáticos diversos.',
                ],
            },
            Tercero: {
                competenciasEspecificas: [
                ...
                criteriosDeEvaluacion: [
                    'Aplicación de estrategias de resolución de problemas dentro y fuera de la matemática.',
                    'Justificación de procesos de razonamientos propios, acerca de una demostración, un algoritmo o un resultado matemático, con su lenguaje cotidiano.',
                    'Uso de herramientas tecnológicas y recursos concretos en la resolución de problemas.',
                ],
            },
            Cuarto: {
                competenciasEspecificas: [
                ...
                criteriosDeEvaluacion: [
                    'Empleo de argumentos lógicos frente a problemas del contexto.',
                    'Aplicación de diferentes estrategias para la resolución de problemas diversos a partir de los conocimientos matemáticos que posee.',
                    'Empleo de herramientas tecnológicas para la interpretación de situaciones desde la matemática.',
                ],
            },
            Quinto: {
                competenciasEspecificas: [
            ...
            Sexto: {
                ...
                criteriosDeEvaluacion: [
                    'Interpretación lógica de situaciones de la comunidad y el Medioambiente a partir de los conocimientos matemáticos que posee.',
                    'Interpretación y solución de situaciones referidas a proyectos comunitarios en la que aplique los conocimientos que posee desde la matemática.',
                    'Propuesta de ideas a partir de proyectos asociados a la matemática empleando herramientas tecnológicas.',
                ],
            },
        },
        EticaYCiudadana: {
            Primero: {
                ...
                criteriosDeEvaluacion: [
                    'Valoración de las ideas matemáticas de sus compañeros al expresar con sentido ético las propias.',
                    'Actitud de respeto frente a diferentes ideas para la solución de una determinada situación de problema.',
                    'Colaboración en el trabajo grupal en matemática y en las iniciativas sociales y ambientalistas.',
                ],
            },
            Segundo: {
                competenciasEspecificas: [
                ...
                criteriosDeEvaluacion: [
                    'Respeto de los puntos de vista y argumentos de los demás en situaciones matemáticas diversas.',
                    'Valoración de los aportes de compañeros ante las diferentes maneras de resolver un problema desde la matemática.',
                    'Actitud de esfuerzo y perseverancia en el trabajo colaborativo.',
                ],
            },
            Tercero: {
                competenciasEspecificas: [
                    'Interpreta posibles soluciones a situaciones del entorno y el medioambiente a partir de sus conocimientos estadísticos.',
                ],
                criteriosDeEvaluacion: [
                    'Responsabilidad ante acciones matemáticas concretas en favor de la comunidad.',
                    'Apertura y receptividad al enfrentarse a una determinada situación de la comunidad en la que deben emplearse los conocimientos matemáticos.',
                    'Identificación de acciones comunitarias a partir de proyectos matemáticos a favor de la salud y el medioambiente.',
                ],
            },
            Cuarto: {
                competenciasEspecificas: [
                    'Reconoce las normas de convivencia y del trabajo en equipo, respetando las ideas de compañeros para llegar aacuerdos sobre los temas matemáticos desarrollados.',
                ],
                criteriosDeEvaluacion: [
                    'Expresión con sentido ético ideas matemáticas a partir de reportes escritos de investigación sobre un proyecto de la comunidad.',
                    'Respeto frente a las ideas matemáticas expuestas por sus compañeros para resolver una situación del entorno.',
                    'Empleo de acciones comunitarias a partir de los resultados de proyectos matemáticos.',
                ],
            },
            Quinto: {
                competenciasEspecificas: [
            ...
            Sexto: {
                ...
                criteriosDeEvaluacion: [
                    'Empleo de manera ética procedimientos matemáticos para dar respuestas a situaciones de la comunidad.',
                    'Actitud crítica y de respeto frente a situaciones diversas que ameriten la aplicación de ideas matemáticas.',
                    'Empleo de los conocimientos estadísticos para el análisis de datos sobre situaciones de salud y medio ambiente.',
                ],
            },
        },
    },
