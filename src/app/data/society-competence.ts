export const SOCIETY_COMPETENCE = {
    Primaria: {
        Comunicativa: {
            Primero: {
                ...
                criteriosDeEvaluacion: [
                    'Comunicación en su entorno familiar y comunitario a partir de la interpretación de las informaciones  del pasado histórico de este.',
                    'Comprensión del pasado y el presente de su historia familiar en relación con su comunidad.',
                    'Explicación del presente y pasado de su comunidad a partir de informaciones de su entorno.',
                ],
            },
            Segundo: {
                competenciasEspecificas: [
                    'Reconoce conceptos e informaciones de su historia familiar y comunitaria; con la finalidad de reflexionar de forma crítica sobre sus ideas y soluciones creativas a situaciones diversas, utilizando la tecnología.',
                ],
                criteriosDeEvaluacion: [
                    'Reconocimiento de informaciones sobre su entorno familiar y comunitario.',
                    'Explicaciones de conceptos e informaciones sobre el pasado y el presente de su historia familiar, comunitaria, siguiendo procedimientos lógicos. ',
                    'Comunicación oral y escrita de informaciones familiares y comunitarias recabada en fuentes diversas.',
                ],
            },
            Tercero: {
                competenciasEspecificas: [
                    'Comunica sus ideas sobre acontecimientos, a partir del análisis de distintas fuentes geográficas e históricas; con la finalidad de comprender el pasado y reconocer el espacio geográfico que ocupa su municipio, provincia, región y país.',
                ],
                criteriosDeEvaluacion: [
                    'Comprensión del pasado de su municipio, provincia, región y país, a partir del análisis de acontecimientos en fuentes históricas y geográficas adecuadas.',
                    'Procedimientos utilizados en el uso de fuentes seguras y confiables para levantar informaciones.',
                    'Uso crítico de las informaciones reconociendo la autoría de esta.',
                ],
            },
            Cuarto: {
                competenciasEspecificas: [
                    'Selecciona fuentes de información seguras y confiables sobre elementos de la geografía e historia del Caribe y las Antillas; con la finalidad de presentar sus argumentos sobre lo investigado.',
                ],
                criteriosDeEvaluacion: [
                    'Respeto de la autoría de la información recabada sobre los temas estudiados.',
                    'Uso adecuado de las informaciones levantadas, mostrando comprensión del tema estudiado.',
                    'Comprensión de las informaciones utilizadas en producciones realizadas.',
                ],
            },
            Quinto: {
                competenciasEspecificas: [
                    'Utiliza fuentes seguras y confiables sobre geografía e historia del continente americano y de la isla de Santo Domingo; con la finalidad de respetar la autoría de las fuentes consultadas. ',
                ],
                criteriosDeEvaluacion: [
            ...
            Sexto: {
                competenciasEspecificas: [
                    'Comprueba la autoría de informaciones sobre la geografía, su clasificación e importancia, así como los aspectos geográficos e históricos de las civilizaciones antiguas y modernas; con la finalidad de producir valoraciones e informaciones científicas y comunicarlas.',
                ],
                criteriosDeEvaluacion: [
                    'Presentación de producciones realizadas sobre el tema estudiado, respetando la autoría de las informaciones.',
                    'Elaboración crítica de las fuentes consultadas al utilizarlas en sus producciones sobre el tema estudiado.',
                    'Producción de informaciones sobre los aspectos históricos y geográficos de las primeras civilizaciones, respetando la autoría de las informaciones levantadas al comunicarlas.',
                ],
            },
        },
        PensamientoLogico: {
            Primero: {
                competenciasEspecificas: [
                    'Reconoce conceptos e informaciones básicas de su familia y su comunidad; con la finalidad de reflexionar en forma crítica y creativa, a partir del uso de la tecnología.',
                ],
                criteriosDeEvaluacion: [
                    'Expresión de ideas y soluciones creativas a situaciones en la familia y la comunidad.',
                    'Organización en forma lógica de conceptos e informaciones básicas de su familia y su comunidad.',
                    'Realización de reflexiones críticas con respecto a los conceptos, informaciones y situaciones de su familia y su comunidad.',
                ],
            },
            Segundo: {
                competenciasEspecificas: [
                    'Comprende de forma crítica conceptos y situaciones problemáticas del espacio natural y social de su entorno comunitario; con la finalidad de aportar ideas y soluciones creativas utilizando tecnología.',
                ],
                criteriosDeEvaluacion: [
                    'Identificación de situaciones problemáticas en su entorno comunitario, organizadas de forma lógica.',
                    'Comprensión crítica de problemas identificados en el espacio natural y social donde vive.',
                    'Contribución con ideas a la solución de situaciones presentadas en su comunidad utilizando la tecnología.',
                ],
            },
            Tercero: {
                competenciasEspecificas: [
                    'Utiliza procedimientos científicos y tecnológicos en el análisis crítico de fenómenos geográficos, hechos históricos y culturales de la provincia, región y país; con la finalidad de aportar ideas y soluciones creativas utilizando la tecnología',
                ],
                criteriosDeEvaluacion: [
                    'Análisis de fenómenos geográficos, históricos y culturales, utilizando procedimientos científicos y tecnológicos.',
                    'Interpretación crítica de los fenómenos en la provincia, región y país.',
                    'Propuesta lógica y creativa sobre fenómenos geográficos, históricos ',
                ],
            },
            Cuarto: {
                competenciasEspecificas: [
                    'Identifica problema en hechos históricos del Caribe y las Antillas en los siglos estudiados; con la finalidad de relacionarlos en forma lógica, creativa y crítica, con el espacio geográfico en el que ocurrieron, con apoyo de la tecnología. ',
                ],
                criteriosDeEvaluacion: [
                    'Descubrimiento de problemas en hechos históricos, ocurridos del siglo XVI al XIX, organizados en forma lógica.',
                    'Relación de los acontecimientos históricos de los siglos estudiados con el espacio geográfico en el que ocurrieron.',
                    'Expresión lógica de las opiniones expresadas sobre los periodos históricos estudiados',
                ],
            },
            Quinto: {
                competenciasEspecificas: [
                    'Analiza situaciones referidas a la geografía, la historia como ciencia, el continente americano, el Caribe y los procesos históricos de República Dominicana; con la finalidad de plantear su punto de vista sobre sus hallazgos de manera lógica, crítica y creativa, usando la tecnología.',
                ],
                criteriosDeEvaluacion: [
            ...
            Sexto: {
                competenciasEspecificas: [
                    'Explica acontecimientos históricos relacionados con las civilizaciones antiguas y modernas, la historia de América durante los siglos XVIII y XIX, situaciones políticas, sociales, económicas y culturales del mundo y de la República Dominicana ocurridos durante la primera y segunda mitad del siglo XIX y el XX; con la finalidad de comprender las causas que dieron origen a estos acontecimientos y expresar su opinión en forma crítica y creativa, usando la tecnología.',
                ],
                criteriosDeEvaluacion: [
                    'Interpretación lógica y crítica de acontecimientos históricos relacionados con las civilizaciones antiguas y modernas y la historia de América durante los siglos XVIII y XIX.',
                    'Descripción lógica y crítica de hechos y situaciones históricas de la primera y segunda mitad del siglo XX, asociados a situaciones sociales, económicas y culturales del mundo y de la República Dominicana.',
                    'Comparación lógica y crítica de períodos estudiados planteando su punto de vista.',
                ],
            },
        },
        EticaYCiudadana: {
            Primero: {
                ...
                criteriosDeEvaluacion: [
                    'Valoración de propuestas que promuevan el respeto a sí mismo y a la demás persona en cualquier espacio, a través sus derechos, el cumplimiento de sus deberes y del cuidado de su entorno natural y social.',
                    'Presentación de argumentaciones sobre sus derechos y deberes en el cuidado de su entorno natural y social.',
                    'Propuestas sobre la exigencia de sus derechos, el cumplimiento de sus deberes y del cuidado de su entorno natural y social.',
                ],
            },
            Segundo: {
                competenciasEspecificas: [
                    'Asume actitudes de respeto hacia sí mismo y hacia las demás personas en cualquier espacio; con la finalidad de construir una ciudadanía basada en la participación democrática, la exigencia de sus derechos, el cumplimiento de sus deberes y el cuidado de su entorno natural y social.',
                ],
                criteriosDeEvaluacion: [
                    'Presentación de planteamientos sobre la exigencia de sus derechos, cumplimiento de los deberes ciudadanos y la protección de su entorno natural, social.',
                    'Promoción de planteamientos sobre la exigencia de sus derechos, cumplimiento de los deberes ciudadanos y la protección de su entorno natural, social.',
                    'Demostración de respeto a través de argumentaciones que proponen una ciudadanía basada en la participación democrática.',
                ],
            },
            Tercero: {
                competenciasEspecificas: [
                    'Integra en su vida el respeto a sí mismo y a las demás personas; con la finalidad de promover relaciones democráticas y armoniosas, el cuidado a su entorno natural y la construcción de una cultura de paz en el municipio y región donde vive.',
                ],
                criteriosDeEvaluacion: [
                    'Promoción del respeto a sí mismo y a las demás personas con las que se relaciona.',
                    'Defensa de planteamientos sobre una ciudadanía basada en la participación democrática.',
                    'Demostración de actitudes democráticas, de una ciudadanía respetuosa de los derechos humanos y promotora de la cultura de paz en su municipio y región donde vive.',
                ],
            },
            Cuarto: {
                competenciasEspecificas: [
                    'Actúa democráticamente, defiende la convivencia pacífica, la preservación de la salud, el patrimonio histórico, natural y cultural del Caribe y la República Dominicana; con la finalidad de construir una ciudadanía basada en el respeto y la cultura de paz.',
                ],
                criteriosDeEvaluacion: [
                    'Demostración de convivencia pacífica, reconociendo las diferencias individuales, sociales y culturales; cuidando la salud personal y el medio ambiente.',
                    'Presentación de argumentaciones lógicas sobre la defensa del patrimonio histórico, natural y cultural de la República Dominicana.',
                    'Demostración de planteamientos sobre la construcción de una ciudadanía responsable.',
                ],
            },
            Quinto: {
                competenciasEspecificas: [
                    'Defiende actitudes democráticas, respeta a los símbolos patrios del país, valora el patrimonio histórico, natural y cultural de Latinoamérica y de República Dominicana; con la finalidad de construir una ciudadanía respetuosa de los derechos humanos y defensora de la cultura de paz.',
                ],
                criteriosDeEvaluacion: [
            ...
            Sexto: {
                competenciasEspecificas: [
                    'Promueve en sus actuaciones, relaciones democráticas, sus deberes y derechos y de los demás, la conservación del patrimonio histórico, natural y cultural dominicano y del mundo; con la finalidad de construir una ciudadanía defensora de un estado de derecho, la interculturalidad y la cultura de paz en diferentes contextos.',
                ],
                criteriosDeEvaluacion: [
                    'Demostración de sensibilidad ante los problemas sociales en su comunidad, en el país y en el mundo, proponiendo ideas para la construcción de la cultura de paz en el mundo.',
                    'Justificación de actuaciones que propicien relaciones democráticas, la conservación del patrimonio histórico, natural y cultural dominicano y del mundo.',
                    'Argumentación sobre la importancia de la exigencia de derechos y el cumplimiento de deberes en una sociedad',
                ],
            },
        },
    },
