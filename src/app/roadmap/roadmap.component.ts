  ...
  stages: Stage[] = [
    {
      ...
      description: 'Para la etapa inicial del proyecto, estarán disponibles estas herramientas.',
      tools: [
        {
    ...
    },
    {
      ...
      description: 'Durante el segundo año del proyecto, se iran agregando los instrumentos mencionados acontinuación.',
      tools: [
        {
    ...
    },
    {
      ...
      description: 'Para el año 2026, está prevista la implementacion el siguiente grupo de herramientas.',
      tools: [
        {
