...
export const loadSubscriptionSuccess = createAction(
	...
	props<{ user_subscriptions: UserSubscription[] }>(),
);
...
export const checkSubscriptionSuccess = createAction(
	...
	props<{ user_subscription: UserSubscription }>(),
);

export const checkSubscriptionFailure = createAction(
	'[Subscription] check failure',
	props<{ error: any }>(),
);

export const findSubscription = createAction(
	'[Subscription] find',
	props<{ id: string }>(),
);

export const findSubscriptionSuccess = createAction(
	'[Subscription] find success',
	props<{ user_subscription: UserSubscription }>(),
);

export const findSubscriptionFailure = createAction(
	'[Subscription] find success',
	props<{ error: any }>(),
);

export const findSubscriptionByUser = createAction(
	'[Subscription] find by user',
	props<{ id: string }>(),
);

export const findSubscriptionByUserSuccess = createAction(
	'[Subscription] find by user success',
	props<{ user_subscription: UserSubscription }>(),
);

export const findSubscriptionByUserFailure = createAction(
	'[Subscription] find by user success',
	props<{ error: any }>(),
);
...
export const updateSubscription = createAction(
	'[Subscription] update',
	props<{ id: string; user_subscription: UserSubscription }>(),
);
