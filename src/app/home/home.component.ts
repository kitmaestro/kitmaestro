...
export class HomeComponent {
  ...
  apps: AppEntry[] = [
    ...
    },
    {
      ...
      link: ['/unit-plans'],
      icon: 'https://app.kitmaestro.com/assets/assistant.svg',
    ...
    },
    {
      ...
      icon: 'https://app.kitmaestro.com/assets/calculator.svg',
    ...
    },
    {
      ...
      icon: 'https://app.kitmaestro.com/assets/attendance.svg',
