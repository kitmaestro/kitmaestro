...
export class SubjectConceptListService {
  ...
  findAll(filters: any): Observable<SubjectConceptList[]> {
    ...
    return this.http.get<SubjectConceptList[]>(this.apiBaseUrl, { ...this.config, params });
  }

  find(id: string): Observable<SubjectConceptList> {
    return this.http.get<SubjectConceptList>(this.apiBaseUrl + id, this.config);
  }

  create(list: SubjectConceptList): Observable<SubjectConceptList> {
    return this.http.post<SubjectConceptList>(this.apiBaseUrl, list, this.config);
  }
