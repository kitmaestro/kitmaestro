...
import { Table, WidthType, TableRow, TableCell, Paragraph, TextRun, PageOrientation, HeadingLevel, AlignmentType, Packer, Document } from 'docx';
...
export class ScoreSystemService {
  ...
  async download(scoreSystem: ScoreSystem, students: Student[]) {
          ...
          children: [
            ...
            new Paragraph({
              children: [
                new TextRun({
                  color: '#000000',
                  text: "Sistema de Calificación de " + this.pretify(scoreSystem.content[0].subject),
                })
              ],
            ...
            new Paragraph({
              children: [
                new TextRun({
                  color: '#000000',
                  text: scoreSystem.content.flatMap(c => c.title).join(', '),
                })
              ],
              heading: HeadingLevel.HEADING_3,
              alignment: AlignmentType.CENTER,
              ...
              return [
                ...
                new Table({
                  ...
                  rows: [
                    ...
                    ...students.flatMap((student, i) => new TableRow({
                      children: [
    ...
    saveAs(blob, `${scoreSystem.content.flatMap(c => c.title)[0]} - Sistema de Calificacion.docx`);
  }
}
