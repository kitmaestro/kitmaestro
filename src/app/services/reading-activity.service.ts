      ...
      sections: [
        {
          ...
          children: [
            ...
            new Paragraph(''),
            new Paragraph({ children: [new TextRun({ text: 'Responde:', bold: true })] }),
            new Paragraph(''),
            ...activity.questions.flatMap((q, i) => [new Paragraph({ children: [new TextRun({ text: (i + 1) + q, bold: true })] }), new Paragraph('')]),
          ]
        }
      ]
    });
