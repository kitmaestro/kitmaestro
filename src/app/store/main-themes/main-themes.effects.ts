        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#mainThemeService.find(id).pipe(
                    map(theme => MainThemesActions.loadThemeSuccess({ theme })),
                    catchError(error => {
                        this.#sb.open('Error al cargar el tema', 'Ok', timing)
                        return of(MainThemesActions.loadThemeFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ filters }) =>
                this.#mainThemeService.findAll(filters).pipe(
                    map(themes => MainThemesActions.loadThemesSuccess({ themes })),
                    catchError(error => {
                        this.#sb.open('Error al cargar los temas', 'Ok', timing)
                        return of(MainThemesActions.loadThemesFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ theme }) =>
                this.#mainThemeService.create(theme).pipe(
                    map(newTheme => {
                        ...
                        return MainThemesActions.createThemeSuccess({ theme: newTheme })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al crear el tema', 'Ok', timing)
                        return of(MainThemesActions.createThemeFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ id, data }) =>
                this.#mainThemeService.update(id, data).pipe(
                    map(updatedTheme => {
                        ...
                        return MainThemesActions.updateThemeSuccess({ theme: updatedTheme })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al actualizar el tema', 'Ok', timing)
                        return of(MainThemesActions.updateThemeFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#mainThemeService.delete(id).pipe(
                    map(() => {
                        this.#sb.open('El tema ha sido eliminado', 'Ok', timing)
                        return MainThemesActions.deleteThemeSuccess({ id })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al eliminar el tema', 'Ok', timing)
                        return of(MainThemesActions.deleteThemeFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
