            ...
            switchMap(({ id }) =>
                this.#todoService.findOne(id).pipe(
                    ...
                    catchError(error => {
                        ...
                        return of(TodosActions.loadTodoFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(() =>
                this.#todoService.findAll().pipe(
                    ...
                    catchError(error => {
                        this.#sb.open('Error al cargar las tareas', 'Ok', timing)
                        return of(TodosActions.loadTodosFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ listId }) =>
                this.#todoService.findByList(listId).pipe(
                    map(todos => TodosActions.loadTodosByListSuccess({ todos })),
                    catchError(error => {
                        this.#sb.open('Error al cargar las tareas de la lista', 'Ok', timing)
                        return of(TodosActions.loadTodosByListFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ todo }) =>
                this.#todoService.create(todo).pipe(
                    ...
                    catchError(error => {
                        ...
                        return of(TodosActions.createTodoFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ id, data }) =>
                this.#todoService.update(id, data).pipe(
                    map(updatedTodo => {
                        ...
                        return TodosActions.updateTodoSuccess({ todo: updatedTodo })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al actualizar la tarea', 'Ok', timing)
                        return of(TodosActions.updateTodoFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#todoService.delete(id).pipe(
                    map(() => {
                        this.#sb.open('La tarea ha sido eliminada', 'Ok', timing)
                        return TodosActions.deleteTodoSuccess({ id })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al eliminar la tarea', 'Ok', timing)
                        return of(TodosActions.deleteTodoFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
