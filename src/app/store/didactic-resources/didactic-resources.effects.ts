        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#didacticResourceService.findOne(id).pipe(
                    map(resource => DidacticResourcesActions.loadResourceSuccess({ resource })),
                    catchError(error => {
                        this.#sb.open('Error al cargar el recurso', 'Ok', timing)
                        return of(
                            DidacticResourcesActions.loadResourceFailed({ error: error.message }),
                        )
                    }),
                ),
            ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(() =>
                this.#didacticResourceService.findAll().pipe(
                    map(resources => DidacticResourcesActions.loadResourcesSuccess({ resources })),
                    catchError(error => {
                        this.#sb.open('Error al cargar los recursos', 'Ok', timing)
                        return of(
                            DidacticResourcesActions.loadResourcesFailed({ error: error.message }),
                        )
                    }),
                ),
            ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(() =>
                this.#didacticResourceService.findMyResources().pipe(
                    map(resources => DidacticResourcesActions.loadMyResourcesSuccess({ resources })),
                    catchError(error => {
                        this.#sb.open('Error al cargar mis recursos', 'Ok', timing)
                        return of(
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ userId }) =>
                this.#didacticResourceService.findByUser(userId).pipe(
                    map(resources =>
                        DidacticResourcesActions.loadUserResourcesSuccess({ resources }),
                    ),
                    catchError(error => {
                        this.#sb.open('Error al cargar los recursos del usuario', 'Ok', timing)
                        return of(
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ resource }) =>
                this.#didacticResourceService.create(resource).pipe(
                    map(newResource => {
                        this.#sb.open('El recurso ha sido creado', 'Ok', timing)
                        return DidacticResourcesActions.createResourceSuccess({
                            resource: newResource,
                        })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al crear el recurso', 'Ok', timing)
                        return of(
                            DidacticResourcesActions.createResourceFailed({ error: error.message }),
                        )
                    }),
                ),
            ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id, data }) =>
                this.#didacticResourceService.update(id, data).pipe(
                    map(updatedResource => {
                        this.#sb.open('El recurso fue actualizado', 'Ok', timing)
                        return DidacticResourcesActions.updateResourceSuccess({
                            resource: updatedResource,
                        })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al actualizar el recurso', 'Ok', timing)
                        return of(
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#didacticResourceService.delete(id).pipe(
                    map(() => {
                        this.#sb.open('El recurso ha sido eliminado', 'Ok', timing)
                        return DidacticResourcesActions.deleteResourceSuccess({ id })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al eliminar el recurso', 'Ok', timing)
                        return of(
            ...
            switchMap(({ id }) =>
                this.#didacticResourceService.bookmark(id).pipe(
                    map(resource => {
                        ...
                        return DidacticResourcesActions.updateResourceSuccess({ resource })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al guardar el recurso', 'Ok', timing)
                        return of(
                            DidacticResourcesActions.updateResourceFailed({
                                error: error.message,
                            }),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#didacticResourceService.like(id).pipe(
                    map(resource => {
                        this.#sb.open('Recurso marcado como "Me gusta"', 'Ok', timing)
                        return DidacticResourcesActions.updateResourceSuccess({ resource })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al procesar "Me gusta"', 'Ok', timing)
                        return of(
                            DidacticResourcesActions.updateResourceFailed({
                                error: error.message,
                            }),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#didacticResourceService.dislike(id).pipe(
                    map(resource => {
                        this.#sb.open('Recurso marcado como "No me gusta"', 'Ok', timing)
                        return DidacticResourcesActions.updateResourceSuccess({ resource })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al procesar "No me gusta"', 'Ok', timing)
                        return of(
                            DidacticResourcesActions.updateResourceFailed({
                                error: error.message,
                            }),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#didacticResourceService.buy(id).pipe(
                    ...
                    catchError(error => {
                        this.#sb.open('Error al comprar el recurso', 'Ok', timing)
                        return of(
                            DidacticResourcesActions.updateResourceFailed({
                                error: error.message,
                            }),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#didacticResourceService.download(id).pipe(
                    ...
                    catchError(error => {
                        this.#sb.open('Error al descargar el recurso', 'Ok', timing)
                        return of(
                            DidacticResourcesActions.updateResourceFailed({
                                error: error.message,
                            }),
