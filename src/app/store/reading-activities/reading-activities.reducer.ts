...
export const readingActivitiesReducer = createReducer(
	...
	on(
		ReadingActivitiesActions.loadActivitiesSuccess,
		(state, { activities }) => ({
			...state,
			status: ReadingActivityStateStatus.IDLING,
			activities,
	...
	on(
		ReadingActivitiesActions.createActivitySuccess,
		(state, { activity }) => ({
			...state,
			status: ReadingActivityStateStatus.IDLING,
	...
	on(
		ReadingActivitiesActions.updateActivitySuccess,
	...
	on(ReadingActivitiesActions.deleteActivitySuccess, (state, { id }) => ({
		...
		status: ReadingActivityStateStatus.IDLING,
		selectedActivity:
			state.selectedActivity?._id === id ? null : state.selectedActivity,
