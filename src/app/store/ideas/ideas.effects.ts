            ...
            switchMap(({ id }) =>
                this.#ideaService.find(id).pipe(
                    ...
                    catchError(error => {
                        ...
                        return of(IdeasActions.loadIdeaFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(() =>
                this.#ideaService.findAll().pipe(
                    ...
                    catchError(error => {
                        this.#sb.open('Error al cargar las ideas', 'Ok', timing)
                        return of(IdeasActions.loadIdeasFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ idea }) =>
                this.#ideaService.create(idea).pipe(
                    map(newIdea => {
                        ...
                        return IdeasActions.createIdeaSuccess({ idea: newIdea })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al crear la idea', 'Ok', timing)
                        return of(IdeasActions.createIdeaFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ id, data }) =>
                this.#ideaService.update(id, data).pipe(
                    map(updatedIdea => {
                        ...
                        return IdeasActions.updateIdeaSuccess({ idea: updatedIdea })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al actualizar la idea', 'Ok', timing)
                        return of(IdeasActions.updateIdeaFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#ideaService.delete(id).pipe(
                    map(() => {
                        this.#sb.open('La idea ha sido eliminada', 'Ok', timing)
                        return IdeasActions.deleteIdeaSuccess({ id })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al eliminar la idea', 'Ok', timing)
                        return of(IdeasActions.deleteIdeaFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
