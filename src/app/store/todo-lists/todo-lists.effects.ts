            ...
            switchMap(({ id }) =>
                this.#todoListService.findOne(id).pipe(
                    ...
                    catchError(error => {
                        ...
                        return of(TodoListsActions.loadListFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(() =>
                this.#todoListService.findAll().pipe(
                    map(lists => TodoListsActions.loadListsSuccess({ lists })),
                    catchError(error => {
                        this.#sb.open('Error al cargar las listas', 'Ok', timing)
                        return of(TodoListsActions.loadListsFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ list }) =>
                this.#todoListService.create(list as any).pipe(
                    map(newList => {
                        ...
                        return TodoListsActions.createListSuccess({ list: newList })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al crear la lista', 'Ok', timing)
                        return of(TodoListsActions.createListFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ id, data }) =>
                this.#todoListService.update(id, data as any).pipe(
                    map(updatedList => {
                        ...
                        return TodoListsActions.updateListSuccess({ list: updatedList })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al actualizar la lista', 'Ok', timing)
                        return of(TodoListsActions.updateListFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ id }) =>
                this.#todoListService.delete(id).pipe(
                    ...
                    catchError(error => {
                        ...
                        return of(TodoListsActions.deleteListFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
