...
import { ScoreSystem, Student } from '../../core/models'
...
export const downloadSystem = createAction(
	'[Score Systems] Download System',
	props<{ system: ScoreSystem, students: Student[] }>(),
)

export const downloadSystemSuccess = createAction('[Score Systems] Download System Success')

export const downloadSystemFailed = createAction(
	'[Score Systems] Download System Failed',
	props<{ error: string }>(),
)
