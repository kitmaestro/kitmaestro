...
export const subjectConceptListsReducer = createReducer(
	...
	on(
		SubjectConceptListsActions.createSubjectConceptListSuccess,
		(state, { list }) => ({
			...state,
			status: SubjectConceptListStateStatus.IDLING,
	...
	on(
		SubjectConceptListsActions.updateSubjectConceptListSuccess,
	...
	on(
		SubjectConceptListsActions.deleteSubjectConceptListSuccess,
		(state, { id }) => ({
			...state,
			status: SubjectConceptListStateStatus.IDLING,
			selectedList:
