        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#subjectConceptListService.find(id).pipe(
                    map(list => SubjectConceptListsActions.loadSubjectConceptListSuccess({ list })),
                    catchError(error => {
                        this.#sb.open('Error al cargar la lista', 'Ok', timing)
                        return of(
                            SubjectConceptListsActions.loadSubjectConceptListFailed({ error: error.message }),
                        )
                    }),
                ),
            ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ filters }) =>
                this.#subjectConceptListService.findAll(filters).pipe(
                    map(lists => SubjectConceptListsActions.loadSubjectConceptListsSuccess({ lists })),
                    catchError(error => {
                        this.#sb.open('Error al cargar las listas', 'Ok', timing)
                        return of(
                            SubjectConceptListsActions.loadSubjectConceptListsFailed({ error: error.message }),
                        )
                    }),
                ),
            ),
            ...
            switchMap(({ list }) =>
                this.#subjectConceptListService.create(list as any).pipe(
                    map(newList => {
                        ...
                        return SubjectConceptListsActions.createSubjectConceptListSuccess({ list: newList })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al crear la lista', 'Ok', timing)
                        return of(
                            SubjectConceptListsActions.createSubjectConceptListFailed({ error: error.message }),
                        )
                    }),
                ),
            ),
            ...
            switchMap(({ id, data }) =>
                this.#subjectConceptListService.update(id, data as any).pipe(
                    map(updatedList => {
                        ...
                        return SubjectConceptListsActions.updateSubjectConceptListSuccess({ list: updatedList })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al actualizar la lista', 'Ok', timing)
                        return of(
                            SubjectConceptListsActions.updateSubjectConceptListFailed({ error: error.message }),
                        )
                    }),
                ),
            ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#subjectConceptListService.delete(id).pipe(
                    map(() => {
                        this.#sb.open('La lista ha sido eliminada', 'Ok', timing)
                        return SubjectConceptListsActions.deleteSubjectConceptListSuccess({ id })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al eliminar la lista', 'Ok', timing)
                        return of(
                            SubjectConceptListsActions.deleteSubjectConceptListFailed({ error: error.message }),
                        )
                    }),
                ),
            ),
