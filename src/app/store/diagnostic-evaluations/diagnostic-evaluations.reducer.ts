...
export const diagnosticEvaluationsReducer = createReducer(
	...
	on(
		DiagnosticEvaluationsActions.loadEvaluationSuccess,
		(state, { evaluation }) => ({
			...state,
			status: DiagnosticEvaluationStateStatus.IDLING,
	...
	on(
		DiagnosticEvaluationsActions.createEvaluationSuccess,
		(state, { evaluation }) => ({
			...state,
			status: DiagnosticEvaluationStateStatus.IDLING,
	...
	on(
		DiagnosticEvaluationsActions.updateEvaluationSuccess,
		(state, { evaluation }) => ({
			...state,
			status: DiagnosticEvaluationStateStatus.IDLING,
			selectedEvaluation:
			...
			evaluations: state.evaluations.map((e) =>
				e._id === evaluation._id ? evaluation : e,
			),
		}),
	),
	on(
		DiagnosticEvaluationsActions.deleteEvaluationSuccess,
		(state, { id }) => ({
			...state,
			status: DiagnosticEvaluationStateStatus.IDLING,
			selectedEvaluation:
				state.selectedEvaluation?._id === id
					? null
					: state.selectedEvaluation,
