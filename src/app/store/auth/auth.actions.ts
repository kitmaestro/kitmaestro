...
export const signInSuccess = createAction(
	...
	props<{ response: LoginOrSignupResponse }>(),
);
...
export const passwordRecoverySuccess = createAction(
	...
	props<{ response: PasswordRecoverResponse }>(),
);
export const passwordRecoveryFailure = createAction(
	'[Auth] Password Recovery Failure',
	props<{ error: string }>(),
);
...
export const passwordResetSuccess = createAction(
	...
	props<{ response: PasswordResetResponse }>(),
);
...
export const sendSignUpRequestEmail = createAction(
	'[Auth] Send SignUp Request Email',
	props<{ data: any }>(),
);
export const sendSignUpRequestEmailSuccess = createAction(
	'[Auth] Send SignUp Request Email Success',
	props<{ response: PasswordResetResponse }>(),
);
export const sendSignUpRequestEmailFailure = createAction(
	'[Auth] Send SignUp Request Email Failure',
	props<{ error: string }>(),
);
