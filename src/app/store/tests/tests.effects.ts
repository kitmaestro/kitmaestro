        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#testService.find(id).pipe(
                    ...
                    catchError(error => {
                        this.#sb.open('Error al cargar la prueba', 'Ok', timing)
                        return of(TestsActions.loadTestFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ filters }) =>
                this.#testService.findAll(filters).pipe(
                    ...
                    catchError(error => {
                        this.#sb.open('Error al cargar las pruebas', 'Ok', timing)
                        return of(TestsActions.loadTestsFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
            ...
            switchMap(({ test }) =>
                this.#testService.create(test).pipe(
                    map(newTest => {
                        ...
                        return TestsActions.createTestSuccess({ test: newTest })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al crear la prueba', 'Ok', timing)
                        return of(TestsActions.createTestFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id, data }) =>
                this.#testService.update(id, data).pipe(
                    map(updatedTest => {
                        this.#sb.open('La prueba fue actualizada', 'Ok', timing)
                        return TestsActions.updateTestSuccess({ test: updatedTest })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al actualizar la prueba', 'Ok', timing)
                        return of(TestsActions.updateTestFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
        ...
        this.#actions$.pipe(
            ...
            switchMap(({ id }) =>
                this.#testService.delete(id).pipe(
                    map(() => {
                        this.#sb.open('La prueba ha sido eliminada', 'Ok', timing)
                        return TestsActions.deleteTestSuccess({ id })
                    }),
                    catchError(error => {
                        this.#sb.open('Error al eliminar la prueba', 'Ok', timing)
                        return of(TestsActions.deleteTestFailed({ error: error.message }))
                    }),
                ),
            ),
        ),
