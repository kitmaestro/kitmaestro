...
export const selectAllTests = createSelector(selectTestsState, state => state.tests)
...
export const selectTestsStatus = createSelector(selectTestsState, state => state.status)

export const selectTestsError = createSelector(selectTestsState, state => state.error)
