		...
		this.#actions$.pipe(
			...
			switchMap(() =>
				this.#unitPlanService.findAll().pipe(
					...
					catchError((error) => {
						this.#sb.open(
							'Error al cargar los planes de unidad',
							'Ok',
							timing,
						);
						return of(
		...
		this.#actions$.pipe(
			...
			switchMap(({ plan }) =>
				this.#unitPlanService.create(plan).pipe(
					map((newPlan) => {
						this.#sb.open(
							'El plan de unidad ha sido creado',
							'Ok',
							timing,
						);
					...
					catchError((error) => {
						this.#sb.open(
							'Error al crear el plan de unidad',
							'Ok',
							timing,
						);
						return of(
		...
		this.#actions$.pipe(
			...
			switchMap(({ id, data }) =>
				this.#unitPlanService.update(id, data).pipe(
					map((response) => {
						this.#sb.open(
							'El plan de unidad fue actualizado',
							'Ok',
							timing,
						);
					...
					catchError((error) => {
						this.#sb.open(
							'Error al actualizar el plan de unidad',
							'Ok',
							timing,
						);
						return of(
		...
		this.#actions$.pipe(
			...
			switchMap(({ id }) =>
				this.#unitPlanService.delete(id).pipe(
					map(() => {
						this.#sb.open(
							'El plan de unidad ha sido eliminado',
							'Ok',
							timing,
						);
					...
					catchError((error) => {
						this.#sb.open(
							'Error al eliminar el plan de unidad',
							'Ok',
							timing,
						);
						return of(
		...
		this.#actions$.pipe(
			...
			switchMap(({ plan, classPlans, user }) =>
				from(
					...
					map(() => {
						this.#sb.open(
							'El plan esta siendo descargado',
							'Ok',
							timing,
						);
					...
					catchError((error) => {
						this.#sb.open(
							'Error al descargar el plan de unidad',
							'Ok',
							timing,
						);
						return of(
