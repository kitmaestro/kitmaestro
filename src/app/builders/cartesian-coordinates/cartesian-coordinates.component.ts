...
export class CartesianCoordinatesComponent implements OnInit {
    ...
    onSubmit() {
        ...
        this.svg = this.generateCartesianCoordinateSystem(data.max, data.steps, data.color);
    ...
    generateIntegerExercises(max: number): string[] {
        ...
        for (let x = 0; x < 10; x++) {
            elements.push(`(${this.randBetween(min, max)}, ${this.randBetween(min, max) })`);
        }
    ...
    generateFractionExercises(max: number): string[] {
        ...
        for (let x = 0; x < 10; x++) {
            elements.push(`(${this.randBetween(min, max)}/${this.randBetween(min, max)}, ${this.randBetween(min, max)}/${this.randBetween(min, max)})`);
        }
    ...
    generateDecimalExercises(max: number): string[] {
        ...
        for (let x = 0; x < 10; x++) {
            elements.push(`(${this.randBetween(min, max, true)}, ${this.randBetween(min, max, true) })`);
        }
