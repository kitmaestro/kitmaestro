export const RELIGION_COMPETENCE = {
	Primaria: {
		Comunicativa: {
			Primero: {
				...
				criteriosDeEvaluacion: [
					'Expresión espontánea, autónoma y libre de sus conocimientos sobre el significado de la celebración de la navidad y de los valores que encierra el nacimiento de Jesús de Nazaret en sus relaciones familiares y sociales.',
				],
			},
			Segundo: {
				competenciasEspecificas: [
					'Reconoce valores en los principales hechos de la historia de Jesús de Nazaret y en la cultura dominicana, con el objetivo de integrarlos en su familia, la escuela y la comunidad a partir de testimonios de personas y textos bíblicos con respeto y alegría.',
				],
				criteriosDeEvaluacion: [
					'Identificación entusiasta, respetuosa y alegre de hechos de la vida de Jesús de Nazaret y de los valores que puede aprender de éste, a partir de las enseñanzas bíblicas.',
				],
			},
			Tercero: {
				competenciasEspecificas: [
					'Plantea sus ideas sobre las diferentes etapas de la vida de Jesús de Nazaret, con la finalidad de aplicar las enseñanzas que de ellas se desprenden en su familia con creatividad y admiración, tomando en cuenta textos de los evangelios. ',
				],
				criteriosDeEvaluacion: [
					'Exposición auténtica, creativa y respetuosa de las etapas de la vida de Jesús de Nazaret y su aplicación en su vida, en su familia y entorno social.',
				],
			},
			Cuarto: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Exposición de sus sentimientos e ideas con aceptación, seguridad, alegría, admiración y agradecimiento a Dios en torno a su vida y los cambios que van aconteciendo en su cuerpo a fin de aceptar sin complejos las características físicas y psicológicas propia de la etapa que viven.',
					'Presentación de informe de manera autónoma, responsable y den gratitud hacia Dios debido a los cambios que se dan en su cuerpo.',
					'Reconocimiento de sus deberes y derechos a fin de construir relaciones de respeto y equidad en su entorno familiar, escolar y social.',
					'Presentación de situaciones y vivencias con responsabilidad, respeto, creatividad y agradecimiento a Dios en las que se promueven el valor de su cuerpo, el derecho de la niñez a ser protegida de todo tipo de maltrato y explotación a fin de promover su bienestar y el de los demás.',
				],
			},
			Quinto: {
				competenciasEspecificas: [
			...
			Sexto: {
				competenciasEspecificas: [
					'Promueve el valor de su cuerpo, el derecho de la niñez a ser protegida de todo tipo de maltrato y explotación a fin de promover su bienestar y el de los demás, con esmero, respeto, agradecimiento a Dios.',
				],
				criteriosDeEvaluacion: [
					'Exposición de sus sentimientos e ideas con aceptación, seguridad, alegría, admiración y agradecimiento a Dios en torno a su vida y los cambios que van aconteciendo en su cuerpo a fin de aceptar sin complejos las características físicas y psicológicas propia de la etapa que viven.',
					'Presentación de informe de manera autónoma, responsable y den gratitud hacia Dios debido a los cambios que se dan en su cuerpo.',
		...
		PensamientoLogico: {
			Primero: {
				...
				criteriosDeEvaluacion: [
					'Identificación de manera entusiasta, alegre y creativa al estilo de Jesús de Nazaret de normas sencillas para la convivencia en el juego.',
					'Reconocimiento y enunciación oral y escrita de normas de convivencia utilizadas en el trato a los demás con la finalidad de resolver situaciones conflictivas en sus relaciones interpersonales.',
					'Utilización responsable y entusiasta de la tecnología tomando como referencia normas de convivencia para propiciar su bienestar y fortalecimiento de las relaciones familiares, escolares y sociales.',
				],
			},
			Segundo: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Comparación de manera autónoma y natural, partiendo de las enseñanzas de Jesús de Nazaret de normas del juego, para su bienestar y el desarrollo de las relaciones armoniosas en su entorno comunitario y escolar.',
					'Comprensión y puesta en práctica con creatividad de normas de convivencia y valores cristianos a partir de las enseñanzas de Jesús de Nazaret y transmitidos a la familia y la cultura, a través de su palabra y obras.',
					'Formulación de normas sencillas a partir de las acciones de Jesús de Nazaret que se puedan aplicar a diferentes situaciones de la vida utilizando las tecnologías.',
				],
			},
			Tercero: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Implementación con espontaneidad, empeño y libertad desde la propuesta de Jesús de Nazaret de normas de convivencia en el juego que posibilitan su bienestar y el cultivo de buenas relaciones con sus compañeros, familiares y demás personas.',
					'Aplicación con alegría y respeto, al estilo de Jesús de Nazaret, de normas sencillas para la convivencia armónica consigo mismo y el trato a los demás en la escuela y la familia. ',
					'Promoción entusiasta y creativa del compañerismo y del bien a los demás a partir del uso de las tecnologías y el establecimiento de normas de convivencia.',
				],
			},
			Cuarto: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Valoración respetuosa y asertiva del rol de los adultos en el mundo laboral y sus aportes a la familia, la sociedad y el entorno como colaboradores de Dios en la creación. ',
					'Realización de análisis crítico y asertivo de normas para el buen uso de las ciencias y las tecnologías y el fomento en relaciones armoniosas entre las personas en el contexto familiar, escolar y social.',
					'Representación respetuosa y creativa del valor del trabajo como parte de la obra creadora de Dios, en el desarrollo de los pueblos y en la búsqueda del bien común.',
				],
			},
			Quinto: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Investigación creativa de los beneficios y perjuicio del uso adecuado o no de las ciencias y las tecnologías en las actividades cotidianas en la familia, escuela y comunidad.',
					'Socialización del modo en que las ciencias y las tecnologías posibilitan la construcción de buenas relaciones entre las personas en los ámbitos social, cultural y espiritual en la mejora de la creación de Dios. ',
					'Presentación creativa de los beneficios y perjuicios en el desarrollo e implementación de las ciencias y las tecnologías para la sociedad y mejora o deterioro de la creación de Dios.',
				],
			},
			Sexto: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Análisis responsable y crítico de características que conforman las relaciones armónicas entre las personas en el contexto laboral, el uso de las ciencias y las tecnologías con la finalidad de identificar y poner de manifiesto por el esfuerzo y el sacrificio de las personas que trabajan y las situaciones de riesgo que afectan negativamente el desarrollo de la niñez.',
					'Implementación respetuosa y asertiva de acciones que favorezcan la paz, el perdón y el amor fraterno entre las personas tomando en cuenta la relación con Dios y el estilo de Jesús.',
					'Promoción responsable, respetuosa y creativa de acciones que a partir del desarrollo y uso adecuado de las ciencias y la tecnología aportan el bien común, en el desarrollo de los pueblos como expresión del amor a Dios.',
				],
			},
		},
		EticaYCiudadana: {
			Primero: {
				competenciasEspecificas: [
					'Reconoce la naturaleza, su cuerpo y el de los demás como criatura de Dios con la finalidad de valorarlos y cuidarlos tomando en cuenta su dimensión espiritual.',
				],
				criteriosDeEvaluacion: [
					'Expresión de respeto y agradecimiento por su cuerpo y como criatura de Dios.',
					'Identificación y valoración de las cualidades de los demás con empatía y respeto.',
					'Expresión espontánea y libre de la creación de la naturaleza como regalos del amor de Dios que hay que cuidar y valorar.',
				],
			},
			Segundo: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Identificación de manera autónoma, creativa y valorativa de acciones que favorecen el cuidado y protección de su cuerpo.',
					'Aplicación de manera creativa, empática y entusiasta de acciones que favorezcan el reconocimiento de los demás como miembro de una gran familia. ',
					'Expresión de respeto y agradecimiento por la naturaleza creada por Dios y que debemos proteger y conservar.',
				],
			},
			Tercero: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Aplicación de manera creativa, respetuosa, responsable y empática de acciones que promuevan el valor que tiene su vida.',
					'Identificación y valoración de forma responsable, libre, dinámica y respeto las cualidades y dignidad de los demás como si fuera él mismo.',
					'Representación de manera creativa, responsable y con curiosidad del modo en que la naturaleza y toda la creación deben ser cuidadas por las personas.',
				],
			},
			Cuarto: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Representación respetuosa, de características de su desarrollo físico, afectivo-sexual y espiritual a partir de la persona de Jesús.',
					'Identificación de valores a partir del amor de Dios a través del amor a sí mismo, a los demás y a la naturaleza. ',
					'Implementación autónoma de acciones en defensa y cuidado de la vida humana en todas sus etapas.',
				],
			},
			Quinto: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Elaboración de propuestas que ayudan al desarrollo físico, afectivo-sexual y espiritual partiendo de la vida y enseñanza de Jesús de Nazaret.',
					'Explicación de las ventajas que tienen las buenas relaciones en su núcleo familiar para un sano desarrollo humano y espiritual. ',
					'Promoción y defensa de la naturaleza como casa común, a partir de situaciones encontradas en su entonto comunitario y escolar.',
				],
			},
			Sexto: {
				competenciasEspecificas: [
				...
				criteriosDeEvaluacion: [
					'Elaboración y promoción de acciones que posibilitan el desarrollo físico, cognitivo, afectivo-sexual y espiritual desde los valores y vida de Jesús de Nazaret.',
					'Presentación del impacto del amor de Dios expresado por Jesús, en la vida de las familias y de las personas.',
					'Análisis de situaciones que perjudican y favorecen la vida humana y el entorno natural creado por Dios como casa común.',
				],
			},
		},
	},
