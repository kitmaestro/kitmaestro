...
export class DidacticResourceService {
	...
	findOne(id: string): Observable<DidacticResource> {
		return this.http.get<DidacticResource>(
			this.apiBaseUrl + id,
			this.config,
		);
	}
	...
	findMyResources(): Observable<DidacticResource[]> {
		return this.http.get<DidacticResource[]>(
			this.apiBaseUrl + 'my-resources',
			this.config,
		);
	}

	create(resource: any): Observable<DidacticResource> {
		return this.http.post<DidacticResource>(
			this.apiBaseUrl,
			resource,
			this.config,
		);
	...
	bookmark(id: string): Observable<ApiUpdateResponse> {
		return this.http.post<ApiUpdateResponse>(
			this.apiBaseUrl + id + '/bookmark',
			{},
			this.config,
		);
	}
