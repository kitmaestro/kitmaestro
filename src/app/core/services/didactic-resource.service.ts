...
export class DidacticResourceService {
	...
	create(resource: Partial<DidacticResourceDto>): Observable<DidacticResource> {
	...
	update(id: string, resource: Partial<DidacticResourceDto>): Observable<DidacticResource> {
