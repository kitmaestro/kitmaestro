...
export class DidacticResourceService {
	...
	update(id: string, resource: any): Observable<DidacticResource> {
		return this.#apiService.patch<DidacticResource>(this.#endpoint + id, resource)
	}
	...
	bookmark(id: string): Observable<DidacticResource> {
		return this.#apiService.post<DidacticResource>(this.#endpoint + id + '/bookmark', {})
	}

	like(id: string): Observable<DidacticResource> {
		return this.#apiService.post<DidacticResource>(this.#endpoint + id + '/like', {})
	}

	dislike(id: string): Observable<DidacticResource> {
		return this.#apiService.post<DidacticResource>(this.#endpoint + id + '/dislike', {})
	}

	buy(id: string): Observable<DidacticResource> {
		return this.#apiService.post<DidacticResource>(this.#endpoint + id + '/buy', {})
	}

	download(id: string): Observable<DidacticResource> {
		return this.#apiService.post<DidacticResource>(this.#endpoint + id + '/download', {})
	}
}
